...
console.log(`Removed last item ${removedItem} from supply changes: ${supplyChanges}`);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');
let delivery = 25;
supplyChanges.push(delivery);
console.log(`Added the value ${delivery} to supply changes: ${supplyChanges}`);
...
for (let inventoryChange of supplyChanges) {
  if (inventoryChange > 0) { 
    stretchPositives.push(inventoryChange); 
  } else if (inventoryChange < 0) {
    stretchNegatives.push(inventoryChange);
  } else {
    stretchZeroes.push(inventoryChange);
  }
}
console.log('Stretch Positives:', stretchPositives);
console.log('Stretch Negatives:', stretchNegatives);
console.log('Stretch Zeros:', stretchZeroes);
